        ...
        <section class="py-12 md:py-16 bg-white border-b border-slate-100">
            <div class="container mx-auto px-4 md:px-6">
                <div class="text-center max-w-2xl mx-auto mb-12">
                    ...
                    <h2 class="text-3xl font-heading font-black text-primary mt-1">Why You Need Us</h2>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-slate-50 p-6 rounded-2xl border border-slate-100 hover:shadow-lg transition-shadow">
                        ...
                        <h3 class="font-heading text-lg font-bold text-primary mb-2">Expert Surgeons</h3>
                    ...
                    <div class="bg-slate-50 p-6 rounded-2xl border border-slate-100 hover:shadow-lg transition-shadow">
                        ...
                        <h3 class="font-heading text-lg font-bold text-primary mb-2">Advanced Technology</h3>
                    ...
                    <div class="bg-slate-50 p-6 rounded-2xl border border-slate-100 hover:shadow-lg transition-shadow">
                        ...
                        <h3 class="font-heading text-lg font-bold text-primary mb-2">NABH Accredited</h3>
                    ...
                    <div class="bg-slate-50 p-6 rounded-2xl border border-slate-100 hover:shadow-lg transition-shadow">
                        ...
                        <h3 class="font-heading text-lg font-bold text-primary mb-2">Humane Touch</h3>
