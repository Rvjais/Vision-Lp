...
$formester_form_id = '83yWA56q0'; // Formester form: "LP - Contoura Vision Surgery in Delhi"
...
$page_title = "Contoura Vision Surgery in Delhi | Vision Eye Centre - Topography-Guided Specs Removal";
$page_description = "Get Contoura Vision surgery in Delhi at Vision Eye Centre. Advanced 22,000 point topography-guided laser specs removal for HD vision. Call +91 9711004422.";
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $base; ?>css/service-lp.css">
    <!-- Google tag (gtag.js) -->
...
<body class="bg-cream font-sans text-slate-800 min-h-screen flex flex-col selection:bg-accent/20 selection:text-primary">
    ...
    <header class="site-header w-full py-3 sm:py-3.5 sticky top-0 z-50">
        <div class="container mx-auto px-4 md:px-6 flex items-center justify-between gap-2 sm:gap-4">
            <!-- Logo Image -->
            <a href="<?php echo $base; ?>index.php" class="flex items-center gap-2 sm:gap-3 group min-w-0">
                <img src="<?php echo $base; ?>assets/images/small-logo.png" alt="Vision Eye Centre Logo" class="h-8 sm:h-10 md:h-12 w-auto object-contain flex-shrink-0">
    ...
    <main class="flex-grow">
        ...
        <!-- Hero Section + Form -->
        <section class="hero relative pt-16 pb-20 md:pt-28 md:pb-32 overflow-hidden bg-cover bg-center" style="background-image: linear-gradient(rgba(11,35,56,0.955), rgba(11,35,56,0.955)), url('<?php echo $base; ?>assets/images/contoura_vision.png');">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="lg:col-span-7 space-y-7 text-white">
                        <div class="pill inline-flex items-center gap-2 text-xs">
                            <i class="fa-solid fa-eye text-accent"></i> Specialized Contoura Vision Laser Centre
                        </div>
                        ...
                        <h1 class="text-[34px] sm:text-[42px] md:text-[50px] lg:text-[58px] font-heading font-semibold leading-[1.1] tracking-[-0.015em] text-white">
                            Contoura Vision Surgery <br>
                            <span class="hl-accent">Topography-Guided Precision</span>
                        </h1>

                        <p class="text-[15.5px] md:text-[17px] text-slate-300/90 leading-[1.75] max-w-xl">
                            Contoura Vision maps 22,000 unique elevation points on your cornea to eliminate spectacle power and correct microscopic surface irregularities for HD 6/6 visual sharpness.
                        </p>

                        <!-- Highlights -->
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-x-6 gap-y-7 pt-8">
                            <div class="stat-tile">
                                <i class="fa-solid fa-bullseye text-gold text-lg mb-1"></i>
                                <h4 class="font-semibold text-white text-sm md:text-[15px] mt-1.5">22,000 Points</h4>
                                <p class="text-[11.5px] text-slate-400 mt-0.5">Elevation Mapping</p>
                            </div>
                            <div class="stat-tile">
                                <i class="fa-solid fa-moon text-sky-300 text-lg mb-1"></i>
                                <h4 class="font-semibold text-white text-sm md:text-[15px] mt-1.5">Zero Glare</h4>
                                <p class="text-[11.5px] text-slate-400 mt-0.5">Night Clarity</p>
                            </div>
                            <div class="stat-tile">
                                <i class="fa-solid fa-clock text-teal text-lg mb-1"></i>
                                <h4 class="font-semibold text-white text-sm md:text-[15px] mt-1.5">10 Minutes</h4>
                                <p class="text-[11.5px] text-slate-400 mt-0.5">Total Duration</p>
                            </div>
                            <div class="stat-tile">
                                <i class="fa-solid fa-shield-halved text-green-400 text-lg mb-1"></i>
                                <h4 class="font-semibold text-white text-sm md:text-[15px] mt-1.5">US-FDA</h4>
                                <p class="text-[11.5px] text-slate-400 mt-0.5">Approved Safety</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-5" id="consultation-form">
                        <div class="form-card p-6 sm:p-8">
                            <div class="mb-4">
                                ...
                                <h3 class="text-[23px] font-heading font-semibold text-primary tracking-[-0.01em] mt-2.5">Book Contoura Vision Check</h3>
                                <p class="text-[12.5px] text-slate-500 mt-2 leading-relaxed">Fill out the form to schedule your Contoura Vision candidacy evaluation.</p>
                            </div>
                            
                            <form id="lead-form" class="space-y-3.5" action="<?php echo $base; ?>thankyou.php" method="POST">
                                <input type="hidden" name="service" value="Contoura Vision">
                                ...
                                <div class="space-y-1">
                                    <label for="comments" class="text-[11px] font-bold uppercase tracking-wider text-slate-600 block">Spectacle Power (Optional)</label>
                                    <textarea id="comments" name="comments" rows="2" placeholder="e.g. -2.5D spherical, both eyes..."
                                        class="field"></textarea>
                                </div>

                                <button type="submit"
                                    class="btn-primary mt-3">
                                    <i class="fa-solid fa-calendar-check"></i> Book Contoura Checkup
                                </button>
                            </form>
                        </div>
                    </div>
        ...
        <!-- Service Showcase Image & Detailed Explanation -->
            ...
            <div class="container mx-auto px-4 md:px-6">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center max-w-6xl mx-auto">
                    ...
                    <div class="lg:col-span-5">
                        <div class="img-frame">
                            <img src="<?php echo $base; ?>assets/images/contoura_vision.png" alt="Contoura Vision Topography Laser Technology" class="w-full h-auto object-cover">
                        </div>
                    </div>
                    
                    <!-- Content -->
                    <div class="lg:col-span-7 space-y-4">
                        <span class="eyebrow">Deep-Dive Technology</span>
                        <h2 class="text-[30px] md:text-[38px] font-heading font-semibold text-primary tracking-[-0.015em] mt-4 leading-[1.2]">Everything About Contoura Vision</h2>
                        <p class="text-slate-600 leading-[1.8] text-[15.5px] md:text-[16.5px] max-w-2xl">
                            Contoura Vision is Topography-Guided Custom Ablation. Standard laser vision correction only treats spectacle power (spherical and cylindrical error). Contoura Vision goes one step further by analyzing and reshaping the unique microscopic curvature of your cornea across 22,000 points.
                        </p>
                        <div class="space-y-3 pt-3 text-sm text-slate-700">
                            <div class="check-row">
                                <i class="fa-solid fa-check text-accent text-sm mt-1"></i>
                                <span>Customized treatment tailored uniquely to your corneal topography</span>
                            </div>
                            <div class="check-row">
                                <i class="fa-solid fa-check text-accent text-sm mt-1"></i>
                                <span>Significantly reduces night halos, glare &amp; light sensitivity</span>
                            </div>
                            <div class="check-row">
                                <i class="fa-solid fa-check text-accent text-sm mt-1"></i>
                                <span>Top-tier US-FDA approved laser technology</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-5xl mx-auto mt-20">
                    <div class="card p-8 space-y-4">
                        ...
                        <h3 class="font-heading font-semibold text-primary text-[19px]">HD 6/5 Visual Clarity</h3>
                        <p class="text-[13.5px] text-slate-600 leading-[1.75]">Delivers visual sharpness that often surpasses normal 6/6 vision, rendering images crisper and brighter.</p>
                    </div>
                    ...
                    <div class="card p-8 space-y-4">
                        ...
                        <h3 class="font-heading font-semibold text-primary text-[19px]">Glare &amp; Halo Elimination</h3>
                        <p class="text-[13.5px] text-slate-600 leading-[1.75]">By smoothing out corneal irregularities, it eliminates halos around headlights during night driving.</p>
                    </div>
                    ...
                    <div class="card p-8 space-y-4">
                        ...
                        <h3 class="font-heading font-semibold text-primary text-[19px]">Painless &amp; Fast Healing</h3>
                        <p class="text-[13.5px] text-slate-600 leading-[1.75]">Takes just 10 minutes using topical numbing drops. Most patients resume work the next day.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-20 md:py-24 bg-[#F6F6F3] border-b border-[#E4E3DE]">
            <div class="container mx-auto px-4 md:px-6">
                <div class="sec-head text-center max-w-2xl mx-auto mb-12">
                    <span class="eyebrow">Expert Surgeons</span>
                    <h2 class="text-[30px] md:text-[38px] font-heading font-semibold text-primary tracking-[-0.015em] mt-4 leading-[1.2]">Lead Contoura Vision Specialists</h2>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                    <div class="card p-7 flex items-center gap-5">
                        <img src="<?php echo $base; ?>assets/images/dr-tushar-grover.webp" alt="Dr. Tushar Grover" class="w-[72px] h-[72px] rounded-full object-cover border border-[#D3D2CB] flex-shrink-0">
                        <div>
                            <h4 class="font-heading font-semibold text-primary text-[19px]">Dr. Tushar Grover</h4>
                            <p class="text-[13px] font-bold text-accent pt-1">Medical Director &amp; Cornea / Refractive Specialist</p>
                            <p class="text-[12.5px] text-slate-500 mt-2 leading-relaxed">MS (Aravind), FAICO (Cornea/Refractive), Narayana Nethralaya Fellow.</p>
                        </div>
                    </div>

                    <div class="card p-7 flex items-center gap-5">
                        <img src="<?php echo $base; ?>assets/images/chairman-dr-grover.webp" alt="Prof. (Dr) A. K. Grover" class="w-[72px] h-[72px] rounded-full object-cover border border-[#D3D2CB] flex-shrink-0">
                        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-2 text-xs">
                        <li><a href="<?php echo $base; ?>index.php" class="hover:text-accent transition-colors">Home</a></li>
                        ...
                        <li><a href="<?php echo $base; ?>privacy-policy.php" class="hover:text-accent transition-colors">Privacy Policy</a></li>
                    </ul>
                </div>
                <div class="space-y-4">
        ...
        if (leadForm) {
            leadForm.addEventListener('submit', function(e) {
                ...
                fetch('https://app.formester.com/forms/<?php echo $formester_form_id; ?>/submissions.json', {
                    ...
                    window.location.href = "<?php echo $base; ?>thankyou.php?service=" + encodeURIComponent(formData.get('service') || '');
                }).catch(error => {
                    console.error(error);
                    window.location.href = "<?php echo $base; ?>thankyou.php?service=" + encodeURIComponent(formData.get('service') || '');
                });
