...
<body class="bg-cream font-sans text-slate-800 min-h-screen flex flex-col selection:bg-accent/20 selection:text-primary">
    ...
    <header class="w-full bg-white border-b border-slate-200 py-3.5 sticky top-0 z-50 shadow-xs">
        <div class="container mx-auto px-4 md:px-6 flex items-center justify-between">
            ...
            <a href="index.php" class="flex items-center gap-3 group">
                ...
                <div class="flex flex-col">
                    <span class="font-heading font-black text-primary text-xl md:text-2xl tracking-tight leading-none">Vision Eye Centre</span>
    ...
    <main class="flex-grow">
        ...
        <!-- Hero Section + Form -->
        <section class="relative pt-12 pb-16 md:pt-16 md:pb-20 overflow-hidden bg-cover bg-center" style="background-image: linear-gradient(to right, rgba(10, 52, 89, 0.94), rgba(15, 76, 129, 0.88)), url('assets/images/contoura_vision.png');">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="lg:col-span-7 space-y-6 text-white">
                        ...
                        <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-heading font-black leading-[1.15] text-white">
                            ...
                            <span class="text-sky-300">Topography-Guided Precision</span>
                        </h1>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
                            <div class="bg-white/10 backdrop-blur-md border border-white/15 p-3 rounded-2xl">
                                ...
                                <h4 class="font-bold text-white text-xs md:text-sm">22,000 Points</h4>
                                <p class="text-[11px] text-sky-200">Elevation Mapping</p>
                            </div>
                            <div class="bg-white/10 backdrop-blur-md border border-white/15 p-3 rounded-2xl">
                                <i class="fa-solid fa-moon text-sky-300 text-lg mb-1"></i>
                                <h4 class="font-bold text-white text-xs md:text-sm">Zero Glare</h4>
                                <p class="text-[11px] text-sky-200">Night Clarity</p>
                            </div>
                            <div class="bg-white/10 backdrop-blur-md border border-white/15 p-3 rounded-2xl">
                                <i class="fa-solid fa-clock text-teal text-lg mb-1"></i>
                                <h4 class="font-bold text-white text-xs md:text-sm">10 Minutes</h4>
                                <p class="text-[11px] text-sky-200">Total Duration</p>
                            </div>
                            <div class="bg-white/10 backdrop-blur-md border border-white/15 p-3 rounded-2xl">
                                <i class="fa-solid fa-shield-halved text-green-400 text-lg mb-1"></i>
                                <h4 class="font-bold text-white text-xs md:text-sm">US-FDA</h4>
                                <p class="text-[11px] text-sky-200">Approved Safety</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-5" id="consultation-form">
                        <div class="bg-white p-6 sm:p-8 rounded-3xl shadow-2xl border border-slate-100">
                            <div class="mb-4">
                                ...
                                <h3 class="text-2xl font-heading font-extrabold text-primary">Book Contoura Vision Check</h3>
                                <p class="text-xs text-slate-500 mt-1">Fill out the form to schedule your Contoura Vision candidacy evaluation.</p>
                            </div>
                            ...
                            <form id="lead-form" class="space-y-3.5" action="thankyou.php" method="POST">
                                ...
                                <div class="space-y-1">
                                    <label for="comments" class="text-xs font-bold text-slate-700 block">Spectacle Power (Optional)</label>
        ...
        <!-- Detailed Contoura Vision Explanation -->
        <section class="py-12 md:py-16 bg-white border-b border-slate-100">
            <div class="container mx-auto px-4 md:px-6">
                <div class="max-w-3xl mx-auto space-y-6 text-center">
                    <span class="text-accent font-bold uppercase tracking-widest text-xs">Deep-Dive Technology</span>
                    <h2 class="text-3xl md:text-4xl font-heading font-black text-primary">Everything About Contoura Vision</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-12">
                    <div class="bg-slate-50 border border-slate-200 p-6 rounded-3xl text-center space-y-3">
                        ...
                        <h3 class="font-bold text-primary text-lg">HD 6/5 Visual Clarity</h3>
                        <p class="text-xs text-slate-600 leading-relaxed">Delivers visual sharpness that often surpasses normal 6/6 vision, rendering images crisper and brighter.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 border border-slate-200 p-6 rounded-3xl text-center space-y-3">
                        ...
                        <h3 class="font-bold text-primary text-lg">Glare &amp; Halo Elimination</h3>
                        <p class="text-xs text-slate-600 leading-relaxed">By smoothing out corneal irregularities, it eliminates halos around headlights during night driving.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 border border-slate-200 p-6 rounded-3xl text-center space-y-3">
                        ...
                        <h3 class="font-bold text-primary text-lg">Painless &amp; Fast Healing</h3>
                        <p class="text-xs text-slate-600 leading-relaxed">Takes just 10 minutes using topical numbing drops. Most patients resume work the next day.</p>
                    </div>
                </div>
            </div>
        </section>

        <!-- 3-Step Contoura Vision Process -->
        <section class="py-12 bg-soft-blue/40 border-b border-slate-100">
            <div class="container mx-auto px-4 md:px-6 text-center">
                <div class="max-w-2xl mx-auto mb-10">
                    <span class="text-accent font-bold uppercase tracking-widest text-xs">Patient Steps</span>
                    <h2 class="text-3xl font-heading font-black text-primary mt-1">3 Simple Steps to Contoura Freedom</h2>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                    <div class="bg-white p-6 rounded-3xl border border-slate-200 text-center space-y-2">
                        <div class="w-12 h-12 rounded-2xl bg-primary text-white font-black text-xl flex items-center justify-center mx-auto mb-3">1</div>
                        <h3 class="font-bold text-primary text-base">Topography Scan</h3>
                        <p class="text-xs text-slate-600">High-resolution Vario Topolyzer scan capturing 22,000 corneal elevation points.</p>
                    </div>

                    <div class="bg-white p-6 rounded-3xl border border-slate-200 text-center space-y-2">
                        <div class="w-12 h-12 rounded-2xl bg-accent text-white font-black text-xl flex items-center justify-center mx-auto mb-3">2</div>
                        <h3 class="font-bold text-primary text-base">Custom Laser Reshaping</h3>
                        <p class="text-xs text-slate-600">Painless 10-minute laser treatment customized precisely to your corneal profile.</p>
                    </div>

                    <div class="bg-white p-6 rounded-3xl border border-slate-200 text-center space-y-2">
                        <div class="w-12 h-12 rounded-2xl bg-teal text-white font-black text-xl flex items-center justify-center mx-auto mb-3">3</div>
                        <h3 class="font-bold text-primary text-base">24-Hour Recovery</h3>
                        <p class="text-xs text-slate-600">Enjoy instant specs freedom and clear HD vision starting the very next morning.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-12 bg-cream border-b border-slate-100">
            <div class="container mx-auto px-4 md:px-6">
                <div class="text-center max-w-2xl mx-auto mb-8">
                    <span class="text-accent font-bold uppercase tracking-widest text-xs">Expert Surgeons</span>
                    <h2 class="text-3xl font-heading font-black text-primary mt-1">Lead Contoura Vision Specialists</h2>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                    <div class="bg-white p-6 rounded-3xl border border-slate-200 flex items-center gap-4 shadow-xs">
                        ...
                        <div>
                            ...
                            <p class="text-xs font-bold text-accent">Medical Director &amp; Cornea / Refractive Specialist</p>
                            <p class="text-xs text-slate-500 mt-1">MS (Aravind), FAICO (Cornea/Refractive), Narayana Nethralaya Fellow.</p>
                        </div>
                    </div>
