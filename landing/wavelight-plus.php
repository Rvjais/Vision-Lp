...
<body class="bg-cream font-sans text-slate-800 min-h-screen flex flex-col selection:bg-accent/20 selection:text-primary">
    ...
    <main class="flex-grow">
        ...
        <section class="relative pt-12 pb-16 md:pt-16 md:pb-20 overflow-hidden bg-cover bg-center" style="background-image: linear-gradient(to right, rgba(10, 52, 89, 0.94), rgba(15, 76, 129, 0.88)), url('assets/images/wavelight_plus.png');">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="lg:col-span-7 space-y-6 text-white">
                        ...
                        <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-heading font-black leading-[1.15] text-white">
                            Wavelight Plus <br>
                            <span class="text-sky-300">(InnovEyes) Treatment</span>
                        </h1>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
                            <div class="bg-white/10 backdrop-blur-md border border-white/15 p-3 rounded-2xl">
                                ...
                                <h4 class="font-bold text-white text-xs md:text-sm">Ray Tracing</h4>
                                <p class="text-[11px] text-sky-200">AI Calculation</p>
                            </div>
                            <div class="bg-white/10 backdrop-blur-md border border-white/15 p-3 rounded-2xl">
                                <i class="fa-solid fa-vr-cardboard text-sky-300 text-lg mb-1"></i>
                                <h4 class="font-bold text-white text-xs md:text-sm">3D Digital Twin</h4>
                                <p class="text-[11px] text-sky-200">Eye Simulation</p>
                            </div>
                            <div class="bg-white/10 backdrop-blur-md border border-white/15 p-3 rounded-2xl">
                                <i class="fa-solid fa-bolt text-teal text-lg mb-1"></i>
                                <h4 class="font-bold text-white text-xs md:text-sm">Ultra Fast</h4>
                                <p class="text-[11px] text-sky-200">Laser Precision</p>
                            </div>
                            <div class="bg-white/10 backdrop-blur-md border border-white/15 p-3 rounded-2xl">
                                <i class="fa-solid fa-star text-green-400 text-lg mb-1"></i>
                                <h4 class="font-bold text-white text-xs md:text-sm">Beyond 6/6</h4>
                                <p class="text-[11px] text-sky-200">Crystal Vision</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-5" id="consultation-form">
                        <div class="bg-white p-6 sm:p-8 rounded-3xl shadow-2xl border border-slate-100">
                            <div class="mb-4">
                                ...
                                <h3 class="text-2xl font-heading font-extrabold text-primary">Book Wavelight Plus Check</h3>
                                <p class="text-xs text-slate-500 mt-1">Schedule a Ray-Tracing diagnostic evaluation with our specialists.</p>
                            </div>
            ...
            <div class="container mx-auto px-4 md:px-6">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center max-w-6xl mx-auto">
                    ...
                    <div class="lg:col-span-7 space-y-4">
                        <span class="text-accent font-bold uppercase tracking-widest text-xs">Revolutionary Innovation</span>
                        <h2 class="text-3xl md:text-4xl font-heading font-black text-primary">How Ray-Tracing Wavelight Plus Works</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-12">
                    <div class="bg-slate-50 border border-slate-200 p-6 rounded-3xl text-center space-y-3">
                        ...
                        <h3 class="font-bold text-primary text-lg">AI Ray Tracing</h3>
                        <p class="text-xs text-slate-600 leading-relaxed">Calculates thousands of light paths through the cornea and lens for unmatched optical mathematical precision.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 border border-slate-200 p-6 rounded-3xl text-center space-y-3">
                        ...
                        <h3 class="font-bold text-primary text-lg">3D Digital Twin</h3>
                        <p class="text-xs text-slate-600 leading-relaxed">Simulates your vision outcome digitally prior to the actual laser application, ensuring flawless results.</p>
                    </div>
                    ...
                    <div class="bg-slate-50 border border-slate-200 p-6 rounded-3xl text-center space-y-3">
                        ...
                        <h3 class="font-bold text-primary text-lg">Unmatched Safety</h3>
                        <p class="text-xs text-slate-600 leading-relaxed">Performed under expert supervision at Vision Eye Centre's NABH accredited surgery suites.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-12 bg-cream border-b border-slate-100">
            <div class="container mx-auto px-4 md:px-6">
                <div class="text-center max-w-2xl mx-auto mb-8">
                    <h2 class="text-3xl font-heading font-black text-primary">Senior Refractive Surgeons</h2>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                    <div class="bg-white p-6 rounded-3xl border border-slate-200 flex items-center gap-4 shadow-xs">
                        ...
                        <div>
                            ...
                            <p class="text-xs font-bold text-accent">Medical Director &amp; LASIK Specialist</p>
                            <p class="text-xs text-slate-500 mt-1">MS (Aravind), FAICO (Cornea), Narayana Nethralaya Fellow.</p>
                        </div>
                    </div>
